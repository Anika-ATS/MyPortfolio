  ...
  return (
    <div>
      <div className="hero min-h-screen bg-purple-100">
        <div className=" hero-content flex flex-col md:flex md:flex-col lg:flex-row ">
          <div className="card-body ms-10 mb-16  rounded-md border-r-[1px] border-l-[2px] border-b-[2px] border-black shadow-gray-600 bg-purple-950  md:ms-20 lg:ms-28">
          ...
          >
            <div className="ms-20 -mt-4 rounded-md  border-b-[6px] border-r-[4px] border-t-[6px] border-purple-950 w-2/3 bg-gradient-to-r from-purple-200 via-purple-400 to-purple-2000 lg:ms-0 md:ms-32">
              ...
              <p className=" p-5 text-justify  font-serif text-purple-950 rounded-lg  shadow-4xl    border-purple-950 hover:animate-bounce    transition-colors duration-100  ">
                ...
                With a strong foundation in front-end technologies and a keen
                eye for design, I am eager to collaborate with experienced
                professionals, contribute to innovative web solutions, and
