    ...
    <div>
      <div className="hero min-h-screen bg-purple-100">
        <div className=" hero-content flex-col lg:flex-row ">
            <div className="card-body ms-28 mb-16  rounded-md border-r-[1px] border-l-[2px] border-b-[2px] border-black shadow-gray-600 bg-purple-950">
                      <Player
                        src={web}
                        className="player  "
                        loop
            ...
            <motion.div 
                 ...
                 className="-ms-4">
            <div className="-mt-4 rounded-md  border-b-[6px] border-r-[4px] border-t-[6px] border-purple-950 w-2/3 bg-gradient-to-r from-purple-200 via-purple-400 to-purple-2000" >
