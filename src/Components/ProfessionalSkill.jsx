...
const ProfessionalSkill = () => {
  return (
    ...
    >
      ...
      <div className="w-1/2 mx-10">
         <div className="py-8 font-serif mx-20">
            <p className="text-3xl font-semibold text-purple-950">Development Skill</p>
         </div>
         <div className="mt-5 w-full flex flex-col gap-5">
            ...
            {/* 5 */}
            <div>
                <p className="text-md font-semibold font-serif uppercase ">Java Script</p>
                <span className="w-2/3 h-2 mt-2 bg-purple-900 inline-flex rounded-md">
                <motion.span 
                    initial={{x:'-100%',opacity:0}}
                    animate={{x:0,opacity:1}}
            ...
            {/* 6 */}
            <div>
                <p className="text-md font-semibold font-serif uppercase ">React JS</p>
                <span className="w-2/3 h-2 mt-2 bg-purple-900 inline-flex rounded-md">
                <motion.span 
                    initial={{x:'-100%',opacity:0}}
                    animate={{x:0,opacity:1}}
            ...
            {/* 7 */}
            <div>
                <p className="text-md font-semibold font-serif uppercase ">Express JS</p>
                <span className="w-2/3 h-2 mt-2 bg-purple-900 inline-flex rounded-md">
                <motion.span 
                    initial={{x:'-100%',opacity:0}}
                    animate={{x:0,opacity:1}}
            ...
            {/* 09 */}
            <div>
                <p className="text-md font-semibold font-serif uppercase ">MongoDb</p>
                <span className="w-2/3 h-2 mt-2 bg-purple-900 inline-flex rounded-md">
                <motion.span 
                    initial={{x:'-100%',opacity:0}}
                    animate={{x:0,opacity:1}}
