  ...
  return (
    <div className="h-min   bg-purple-200" id="skill">
      <div className="mx-5 flex  ">
        <div className="mx-5 w-12 mt-20 ">
          <Player src={Skill} className="player  " loop autoplay />
        </div>
        <h1 className=" text-4xl font-bold text-purple-950 mt-20">
          My Skills{" "}
        </h1>
      </div>

      <div className="mx-40 mt-16  grid grid-cols-5">
        {/* 1 */}
        <motion.div
        ...
        <motion.div
          ...
          className=" w-4/5  h-40 rounded-lg  mt-10 shadow-4xl  border border-y-4  bg-gradient-to-r from-purple-950 via-purple-400 to-pink-400 border-purple-950 hover:animate-bounce    transition-colors duration-100 "
        >
          <h1 className="mt-2 mx-2 font-serif font-semibold text-sm text-purple-200">
            Tailwind CSS
          </h1>
          <div className="card-body ">
            <div>
        ...
        <motion.div
          ...
          className=" w-4/5 mb-20 h-40 rounded-lg  mt-10 shadow-4xl  border border-y-4  bg-gradient-to-r from-purple-950 via-purple-400 to-pink-400 border-purple-950 hover:animate-bounce    transition-colors duration-100 "
        >
          <h1 className="mt-2 mx-2 font-serif font-semibold text-md text-purple-200">
            React JS
          </h1>
